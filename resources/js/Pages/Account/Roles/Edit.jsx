...
export default function RoleEdit() {
    ...
    return (
        <>
            <Head>
                <title>Edit Roles - Kita Mampu</title>
            </Head>
            <LayoutAccount>
                                                ...
                                                {permissions.map((permission) => (
                                                    <div className="col-12 col-md-4" key={Math.random()}>
                                                        <div className="form-check form-check-inline">
                                                            <input className="form-check-input" type="checkbox" value={permission.name} defaultChecked={permissionsData.some((name) => name === permission.name ?? true)} onChange={handleCheckboxChange} id={`check-${permission.id}`} />
