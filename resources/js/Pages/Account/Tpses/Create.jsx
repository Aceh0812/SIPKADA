...
export default function KecamatanCreate() {
    ...
    return (
        <>
            <Head>
                <title>TAMBAH TPS - SIPKADA</title>
            </Head>
            <LayoutAccount>
                    ...
                    <div className="col-12">
                        <div className="card border-0 rounded shadow-sm border-top-success">
                            <div className="card-header">
                                <span className="font-weight-bold"><i className="fa fa-folder"></i> Tambah TPS</span>
                            </div>
                            <div className="card-body">
                                ...
                                <div className="row">
                                    ...
                                    <div className="mb-3">
                                        <label className="form-label fw-bold">Nama TPS</label>
                                        <input type="text" className="form-control" value={tps} onChange={(e) => setTps(e.target.value)} placeholder="Tambah Nama TPS" />
                                    </div>
                                    {errors.name && (
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <input type="text" className="form-control" value={jumlah_dpt} onChange={(e) => setJumlahDpt(e.target.value)} placeholder="Tambah Jumlah DPT" />
                                    </div>
                                    {errors.name && (
                                        <div className="alert alert-danger">
                                            {errors.name}
