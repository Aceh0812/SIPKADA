...
export default function UserCreate() {
    ...
    const { errors, roles,saksis } = usePage().props;
    const type_users = [
                    { id: 1, type: 1 },
                    { id: 2, type: 2 },
                ];
    ...
    const [saksi_id, setSaksiId] = useState(null);
...
const storeUser = async (e) => {
    ...
    // Add saksi_id if it is not null
    if (saksi_id !== null) {
        data.saksi_id = saksi_id.value;
    }

    //sending data
    Inertia.post('/account/users', data, {
        onSuccess: () => {
            //show alert
            Swal.fire({
                title: 'Success!',
    ...
    return (
        <>
            <Head>
                <title>Create Users - Kita Mampu</title>
            </Head>
            <LayoutAccount>
                            ...
                            <div className="card-body">
                                <form onSubmit={storeUser}>
                                    ...
                                    <div className="row mb-3">
                                        <div className="col-md-6">
                                        <div className="mb-3">
                                    <label className="form-label fw-bold">Saksi</label>
                                    <Select options={saksis} value={saksi_id} onChange={(option) => setSaksiId(option)}/>
                                   </div>
                                        </div>
                                        <div className="col-md-6">
                                        <div className="mb-3">
